...
pub async fn update_node_description(pool: &PgPool, node_id: Uuid, description: &str) -> Result<bool, sqlx::Error> { workspace_repository::update_node_description(pool, node_id, description).await }
